...
public final class DashboardView extends Panel implements View, DashboardEditListener {
	...
	private Component buildNotes() {
		...
		notes.setValue(
				"Remember to:\n· Zoom in and out in the Groups view\n· Filter the users and drag a set of them to the Reports tab\n· Create a new report\n· Change the schedule of the movie theater");
		notes.setSizeFull();
	...
	public static final class NotificationsButton extends Button {
		...
		public void updateNotificationsCount(final NotificationsCountUpdatedEvent event) {
			...
			setUnreadCount(DashboardUI.getDataProvider().getUnreadNotificationsCount() + x);
		}
