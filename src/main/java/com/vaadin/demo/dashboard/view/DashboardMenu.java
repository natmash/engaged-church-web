...
import com.churchmanager.event.DashboardEvent.PostViewChangeEvent;
import com.churchmanager.event.DashboardEvent.ProfileUpdatedEvent;
...
public final class DashboardMenu extends CustomComponent {
	...
	private static final String CHURCH = "Beautiful Savior";
	...
	private Component buildTitle() {
		Label logo = new Label(CHURCH + " <strong>Dashboard</strong>", ContentMode.HTML);
	...
	private Component buildMenuItems() {
		...
		for (final DashboardViewType view : DashboardViewType.values()) {
			...
			if (view == DashboardViewType.DIRECTORY) {
				...
				reports.setDropHandler(new DropHandler() {
					...
					public void drop(final DragAndDropEvent event) {
						UI.getCurrent().getNavigator().navigateTo(DashboardViewType.DIRECTORY.getViewName());
	...
	public final class ValoMenuItemExpand extends Accordion {

		private static final String STYLE_SELECTED = "selected";

		public ValoMenuItemExpand() {
			setPrimaryStyleName("valo-menu-item");
			setCaption("Mobile App");
		}

		public void addEntry(final DashboardViewType view) {
