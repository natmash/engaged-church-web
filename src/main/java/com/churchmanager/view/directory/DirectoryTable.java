...
// import com.vaadin.ui.Window;import
// com.vaadin.ui.themes.ValoTheme;anager.view.directory;
//
// public class DirectoryTable extends Tree {
//
...
//
// private static final String ADDRESS_COLUMN = "username";
//
// private static final String PHONE_COLUMN = "status";
//
...
// container.addContainerProperty(PHONE_COLUMN, String.class, null);
// container.addContainerProperty(ADDRESS_COLUMN, String.class, null);
...
// item.getItemProperty(PHONE_COLUMN).setValue(user.getStatus());
// item.getItemProperty(LAST_NAME_COLUMN).setValue(user.getLastName());
//
...
//
// setVisibleColumns(USERNAME, FIRST_NAME_COLUMN, LAST_NAME_COLUMN,
// STATUS_COLUMN, EDIT_COLUMN);
...
//
// subContent.addComponent(new Label(user.getFirstName() + " " +
// user.getLastName()));
...
// @Override
// public void buttonClick(ClickEvent event) {
// final DeleteWindow window = new DeleteWindow(user.getFirstName() + " " +
// user.getLastName());
// getUI().addWindow(window);
